 ...
 */
public class FollowingFriendFragment extends Fragment {
   FollowingFriendFragment.ViewHolder viewHolder;
    ...
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savingInstanceState) {
        View v = inflater.inflate(R.layout.fragment_following_friend, container, false);
        viewHolder = new FollowingFriendFragment.ViewHolder(v);
        init();
        event();
        return v;
    }
    ...
    private void init() {
        ...
        adapter = new FriendAdapter(getActivity(),R.layout.item_friend,new ArrayList<User>(),false);
        viewHolder.lvFollowing.setAdapter(adapter);
    }
    ...
    private void loadData() {
        service.getAccountService().getFollowing(userId).enqueue(new Callback<ResponseModel<List<User>>>() {
            @Override
    ...
    private final class ViewHolder{
        ...
        ViewHolder(View v){
            ...
            lvFollowing = (ListView) v.findViewById(R.id.lv_friend_following);
